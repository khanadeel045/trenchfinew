      ...
      <div className="absolute -top-20 -right-0" >
        ...
        <svg width="658" height="873" viewBox="0 0 658 873" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute top-0">
          <g filter="url(#filter0_f_102_212)">
            <circle cx="601.5" cy="271.5" r="283.5" fill="#7C3CB4" fillOpacity="0.31" />
          </g>
          <defs>
            <filter id="filter0_f_102_212" x="0.399994" y="-329.6" width="1202.2" height="1202.2" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <svg width="79" height="27" viewBox="0 0 79 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M0.978516 17.2792C3.92331 16.4615 6.44742 14.8004 8.71912 12.3216C13.6412 6.95084 14.5246 4.47207 17.1048 6.12461C19.685 7.77715 26.7805 16.453 32.586 14.8004C38.3914 13.1479 45.487 -3.37749 57.0979 1.99326C68.7088 7.36401 73.2242 10.2559 78.3846 6.95084" stroke="#C6B164" strokeWidth="1.5" />
                  <defs>
                    <linearGradient id="paint0_linear_102_662" x1="0.978516" y1="9.51054" x2="78.3846" y2="9.51054" gradientUnits="userSpaceOnUse">
                      <stop stopColor="#C6B164" stopOpacity="0" />
                      <stop offset="1" stopColor="#C6B164" stopOpacity="0.26" />
                    </linearGradient>
                  </defs>
                </svg>
